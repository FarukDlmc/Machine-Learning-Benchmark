...
# CDC Verisinde Target en baştadır
...
# Random Forest'ın 'Recall' değerine dikkat et, muhtemelen en yükseği bu olacak.
...
dosya_ismi = f"cdc_random_forest_sonuc_{zaman_damgasi}.png"
