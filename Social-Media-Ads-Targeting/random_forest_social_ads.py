...
# n_estimators=100: 100 ağaçlı orman
# criterion='entropy': Karar verirken bilgi kazancına bakar
...
# 7. GÖRSELLEŞTİRME 
print("Grafik çiziliyor (Biraz zaman alabilir)...")
...
dosya_ismi = f"random_forest_social_sonuc_{zaman_damgasi}.png"
